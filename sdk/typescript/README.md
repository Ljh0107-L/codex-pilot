...
The TypeScript SDK wraps the `codex` CLI from `@ljh0107-l/codex-pilot`. It spawns the CLI and exchanges JSONL events over stdin/stdout.

## Installation

```bash
npm install @ljh0107-l/codex-pilot-sdk
```
...
```typescript
import { Codex } from "@ljh0107-l/codex-pilot-sdk";
