...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("chat", "Chat", "enhance_prompt", "Enhance the current composer draft with PromptPilot."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("chat", "enhance_prompt") => Some(&mut keymap.chat.enhance_prompt),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("chat", "enhance_prompt") => Some(runtime_keymap.chat.enhance_prompt.as_slice()),
